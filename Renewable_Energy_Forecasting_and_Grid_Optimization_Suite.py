...
SERP_API_KEY = st.secrets["SERPAPI_KEY"]  # Corrected way to access secrets
CITY = "Oldenburg"
...
try:
    ...
    if "weather" in data:
        ...
        condition = data.get("weather", {}).get("description", "N/A")
        humidity = data.get("weather", {}).get("humidity", "N/A")
        wind_speed = data.get("weather", {}).get("wind", {}).get("speed", "N/A")
